...
async function articleItem(source, url) {
  try {
    ...
    const visitorRelevant =
      /heritage|walk|festival|mahotsav|mushaira|concert|music|sufi|ghazal|shayari|poetry|exhibition|museum|monument|imambara|residency|rumi darwaza|tourism|cultural|culture|theatre|theater|performance|art show|book fair|book festival|traffic diversion|traffic advisory|route diversion|road closed|no entry|closure|closed for restoration|restoration|conservation|timing change|new timings|opening hours|janeshwar mishra park|kukrail/i
        .test(relevanceText);
